// -*- C++ -*-
// --------------------------------------------------------------------------------------
// ATtiny88-PU based wireless sprinkler controller for DC latching solenoids.
...
//
//      Physical pins on ATT88-PU              RFM69CW
//              16 (SS)                         7 (NSS)
//              17 (MOSI)                       5 (MOSI)
//              18 (MISO)                       8 (MISO)
//              19 SCK                          6 (SCK)
//               4 (INT0/2/PCINT18/PD2)         9 (DIO0)
//
// Following are the connections for programming the ATT88-PU using Ardiuno UNO as ISP.
//
...
#define tempPin       A0      // TMP36 Vout connected to A0,D10 (ATtiny pin 13)
#define tempPower     A1      //was:9    TMP36 Power pin is connected on pin A1,D9 (ATtiny pin 12)
#define SOLENOID_CTL0 A2      // A2,D8 (ATtiny pin 11)
#define SOLENOID_CTL1 A3      // A3,D7 (ATtiny pin 10)

#define PIN_BIN2   A1  // Physical pin 12 - BIN2 (PH)
#define PIN_BIN1   A2  // Physical pin 11 - BIN1 (EN)
#define PIN_SLP    A3  // Physical pin 10 - SLP
