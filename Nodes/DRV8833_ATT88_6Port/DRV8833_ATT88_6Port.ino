...
#define SLP    PIN_D5  // D6 (AT88 pin 11)
#define COMMN  PIN_D6  // D6 (AT88 pin 12) IB1_0, IA1_0, IB1_1, IA1_1, IB1_2, IA1_2
#define PORT0  PIN_B0  // B0 (AT88 pin 14) IB2_0
#define PORT1  PIN_D7  // D7 (AT88 pin 13) IA2_0
#define PORT2  PIN_D4  // D4 (AT88 pin 06) IB2_1
#define PORT3  PIN_D3  // D3 (AT88 pin 05) IA2_1
#define PORT4  PIN_D1  // D1 (AT88 pin 03) IB2_2
#define PORT5  PIN_D0  // D0 (AT88 pin 02) IA2_2
...
#define N_PORT_CTRL_BITS_D 7
#define N_PORT_CTRL_BITS_B 1
static const byte portD2BitMap[N_PORT_CTRL_BITS_D]={0,1,3,4,5,6,7}; //Pins: D0, D1, D3, D4, D5, D6, D7
static const byte portB2BitMap[N_PORT_CTRL_BITS_B]={0};             //Pins: B0
...
void setup()
{
  ...
  for(port=0;port<N_PORT_CTRL_BITS_D;port++)
    setSolenoid(CLOSE,port); 
  // Set A0-3, A7 and B0 to LOW
  setPortD(port,0x00);PORTD=port;
...
void loop()
{
  for(byte port=0;port<N_PORT_CTRL_BITS_D;port++)
    {
      setSolenoid(OPEN,port,portD2BitMap); // This generates a 10ms pulse which draws current
      hibernate(60000,1);
      setSolenoid(CLOSE,port,portD2BitMap);// This generates a 10ms pulse which draws current
      hibernate(5000,1);
    }
...
#define MASK_PORTD 0b11011111 //Only bits with 1 will be modified
#define MASK_PORTB 0b10000000 //Only bits with 1 will be modified
